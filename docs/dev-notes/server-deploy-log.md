...
| Текущая версия | versionCode 29 (0.16.6 — толерантное время сервера, независимая отправка), sha256 `6cffa3a25f860e6664e2f59671e42457e62f91ac73421aaaa184a5ef5e99286d`; раздача обновлена 2026-09-11 |
